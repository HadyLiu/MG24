...
public:
  ...
  using MatterReportCallback = void (*)(bool on, uint8_t brightness,
   ...
   * @param opId        渐变算子
   */
  void ProcessMatterCommand(const uint16_t *pWrgbBuffer, uint8_t brightness,
  ...
  /** @brief 是否处于极低电量锁死 */
  bool IsBatteryLowLocked() const { return m_isBatteryLow; }
...
private:
  ...
  static constexpr uint8_t kBrightnessLevels[] = {255U, 128U, 0U};

  static const EffectRenderAction
      kActionTable[static_cast<uint8_t>(LightEffectOpId::MaxOperators)];
};

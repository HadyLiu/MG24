...
#define SL_CATALOG_PWM_INDIC_LED0_PRESENT
#define SL_CATALOG_PWM_W_LED0_PRESENT
...
#define SL_CATALOG_BTN_RST0_PRESENT
#define SL_CATALOG_SIMPLE_BUTTON_BTN_RST0_PRESENT

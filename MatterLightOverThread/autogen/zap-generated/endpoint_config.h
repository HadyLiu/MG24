...
\
  ...
  { ZAP_SIMPLE_DEFAULT(41943), 0x00000032, 2, ZAP_TYPE(INT16U), ZAP_ATTRIBUTE_MASK(READABLE) }, /* ColorPointRX */  \
  { ZAP_SIMPLE_DEFAULT(21626), 0x00000033, 2, ZAP_TYPE(INT16U), ZAP_ATTRIBUTE_MASK(READABLE) }, /* ColorPointRY */  \
  { ZAP_SIMPLE_DEFAULT(19660), 0x00000036, 2, ZAP_TYPE(INT16U), ZAP_ATTRIBUTE_MASK(READABLE) }, /* ColorPointGX */  \
  { ZAP_SIMPLE_DEFAULT(39321), 0x00000037, 2, ZAP_TYPE(INT16U), ZAP_ATTRIBUTE_MASK(READABLE) }, /* ColorPointGY */  \
  { ZAP_SIMPLE_DEFAULT(9830), 0x0000003A, 2, ZAP_TYPE(INT16U), ZAP_ATTRIBUTE_MASK(READABLE) }, /* ColorPointBX */  \
  { ZAP_SIMPLE_DEFAULT(3932), 0x0000003B, 2, ZAP_TYPE(INT16U), ZAP_ATTRIBUTE_MASK(READABLE) }, /* ColorPointBY */  \

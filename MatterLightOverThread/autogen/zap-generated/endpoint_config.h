...
\
  ...
  { ZAP_SIMPLE_DEFAULT(0), 0x00000032, 2, ZAP_TYPE(INT16U), ZAP_ATTRIBUTE_MASK(READABLE) }, /* ColorPointRX */  \
  { ZAP_SIMPLE_DEFAULT(0), 0x00000033, 2, ZAP_TYPE(INT16U), ZAP_ATTRIBUTE_MASK(READABLE) }, /* ColorPointRY */  \
  { ZAP_SIMPLE_DEFAULT(0), 0x00000036, 2, ZAP_TYPE(INT16U), ZAP_ATTRIBUTE_MASK(READABLE) }, /* ColorPointGX */  \
  { ZAP_SIMPLE_DEFAULT(0), 0x00000037, 2, ZAP_TYPE(INT16U), ZAP_ATTRIBUTE_MASK(READABLE) }, /* ColorPointGY */  \
  { ZAP_SIMPLE_DEFAULT(0), 0x0000003A, 2, ZAP_TYPE(INT16U), ZAP_ATTRIBUTE_MASK(READABLE) }, /* ColorPointBX */  \
  { ZAP_SIMPLE_DEFAULT(0), 0x0000003B, 2, ZAP_TYPE(INT16U), ZAP_ATTRIBUTE_MASK(READABLE) }, /* ColorPointBY */  \
  ...
  { ZAP_SIMPLE_DEFAULT(0x0099), 0x0000400B, 2, ZAP_TYPE(INT16U), ZAP_ATTRIBUTE_MASK(READABLE) }, /* ColorTempPhysicalMinMireds */  \
...
#define GENERATED_ENDPOINT_TYPES { \
  { ZAP_CLUSTER_INDEX(0), 13, 19 }, \
  { ZAP_CLUSTER_INDEX(13), 7, 101 }, \
}

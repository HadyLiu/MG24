...
#include "sl_simple_button_btn_rst0_config.h"
...
sl_simple_button_context_t simple_btn_rst0_context = {
  .state = 0,
  .history = 0,
  .port = SL_SIMPLE_BUTTON_BTN_RST0_PORT,
  .pin = SL_SIMPLE_BUTTON_BTN_RST0_PIN,
  .mode = SL_SIMPLE_BUTTON_BTN_RST0_MODE,
};

const sl_button_t sl_button_btn_rst0 = {
  .context = &simple_btn_rst0_context,
  .init = sl_simple_button_init,
  .get_state = sl_simple_button_get_state,
  .poll = sl_simple_button_poll_step,
  .enable = sl_simple_button_enable,

...
void HalSpiSm15135e::SendReset()
{
    ...
    (void)SPIDRV_MTransmitB(sl_spidrv_eusart_rgb_data_handle, s_reset_buf, sizeof(s_reset_buf));
}
 ...
 */
void HalSpiSm15135e::SetRgbwyDuty(uint16_t r, uint16_t g, uint16_t b, uint16_t w, uint16_t y)
{
...
void HalSpiSm15135e::SendFrame()
{
    ...
    uint16_t gray_channels[5] = {p_pixel_storage_->r, p_pixel_storage_->g, p_pixel_storage_->b, p_pixel_storage_->w,
                                 p_pixel_storage_->y};
    ...
    for (uint8_t i = 0; i < 5; ++i)
    {
        ...
        s_frame_buf[byte_idx++] = PackSpiBytePureRaw(extractor.bits.b15, extractor.bits.b14);
        s_frame_buf[byte_idx++] = PackSpiBytePureRaw(extractor.bits.b13, extractor.bits.b12);
        s_frame_buf[byte_idx++] = PackSpiBytePureRaw(extractor.bits.b11, extractor.bits.b10);
        s_frame_buf[byte_idx++] = PackSpiBytePureRaw(extractor.bits.b9, extractor.bits.b8);
        s_frame_buf[byte_idx++] = PackSpiBytePureRaw(extractor.bits.b7, extractor.bits.b6);
        s_frame_buf[byte_idx++] = PackSpiBytePureRaw(extractor.bits.b5, extractor.bits.b4);
        s_frame_buf[byte_idx++] = PackSpiBytePureRaw(extractor.bits.b3, extractor.bits.b2);
        s_frame_buf[byte_idx++] = PackSpiBytePureRaw(extractor.bits.b1, extractor.bits.b0);
    }
    ...
    s_frame_buf[byte_idx++] = PackSpiBytePureRaw(extractor.bits.b31, extractor.bits.b30);
    s_frame_buf[byte_idx++] = PackSpiBytePureRaw(extractor.bits.b29, extractor.bits.b28);
    s_frame_buf[byte_idx++] = PackSpiBytePureRaw(extractor.bits.b27, extractor.bits.b26);
    s_frame_buf[byte_idx++] = PackSpiBytePureRaw(extractor.bits.b25, extractor.bits.b24);
    s_frame_buf[byte_idx++] = PackSpiBytePureRaw(extractor.bits.b23, extractor.bits.b22);
    s_frame_buf[byte_idx++] = PackSpiBytePureRaw(extractor.bits.b21, extractor.bits.b20);
    s_frame_buf[byte_idx++] = PackSpiBytePureRaw(extractor.bits.b19, extractor.bits.b18);
    s_frame_buf[byte_idx++] = PackSpiBytePureRaw(extractor.bits.b17, extractor.bits.b16);
    s_frame_buf[byte_idx++] = PackSpiBytePureRaw(extractor.bits.b15, extractor.bits.b14);
    s_frame_buf[byte_idx++] = PackSpiBytePureRaw(extractor.bits.b13, extractor.bits.b12);
    s_frame_buf[byte_idx++] = PackSpiBytePureRaw(extractor.bits.b11, extractor.bits.b10);
    s_frame_buf[byte_idx++] = PackSpiBytePureRaw(extractor.bits.b9, extractor.bits.b8);
    ...
    {
        if (old_standby_ == static_cast<uint8_t>(HalSpiSm15135e::StandbyMode::Sleep))
        {
    ...
    do
    {
        (void)SPIDRV_MTransmitB(sl_spidrv_eusart_rgb_data_handle, s_frame_buf, sizeof(s_frame_buf));
        if (time_counter > 1)
        {
